 ...
 * 
 */
public class SolrPagination<T> implements Serializable {
	...
	private Map<String, Map<String, SolrGroupVo<T>>> groupRes;
	
	private Map<String, Map<String, Long>> facetRes;
	...
	public SolrPagination(int pageSize, int page, boolean queryRecordCount) {
		if (pageSize < 1) {
			throw new IllegalArgumentException("Count should be greater than zero!");
		} else if (currentPage < 1) {
			page = 1;
	...
	public static boolean hasResults(SolrPagination<?> page) {
	...
	public Map<String, Map<String, SolrGroupVo<T>>> getGroupRes() {
		return groupRes;
	}
	public void setGroupRes(Map<String, Map<String, SolrGroupVo<T>>> groupRes) {
		this.groupRes = groupRes;
	}
	public Map<String, Map<String, Long>> getFacetRes() {
		return facetRes;
	}
	public void setFacetRes(Map<String, Map<String, Long>> facetRes) {
		this.facetRes = facetRes;
	}
