/**  
* @Title: RedisBillLockHandler.java
* @Package com.lzy.block.core.redis.util
* @author 李志勇  
* @date 2014年12月24日 上午10:25:04
* @version V1.0  
*/ 
package com.lzy.block.core.redis.util;
...
/**
 * @ClassName: RedisBillLockHandler
 * @Description: 分布式锁  
 * @author 李志勇
 * @date 2014年12月24日 上午10:25:04
 *
...
public class RedisBillLockHandler   {  
    ...
    private static Logger LOGGER = Logger.getLogger(RedisBillLockHandler.class.getName());
