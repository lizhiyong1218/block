...
//        config.setMaxWait(1000l); 
        ...
        jedisPool = new JedisPool(config,"192.168.137.128",6379);
    }
...
//        config.setMaxWait(1000l); 
        ...
        shards.add(new JedisShardInfo("192.168.137.128", 6379, "master")); 
...
//    	  JedisShardInfo  jedisShardInfo = new JedisShardInfo("192.168.137.128", 6379);
//          jedisShardInfo.setPassword("87980879");//密码认证
