...
public class SimpleTest {  
	...
	private static void testMongoDBConn() {
		...
		try {
			...
			//得到Table
			MongoCollection<Document> collection = mdb.getCollection("test");
...
//			doc.put("count", 1);  
//			doc.put("info", new Document("x", 203).append("y", 102));
//	        collection.insertOne(doc);
...
//	         }  
	         ...
	         // 根据条件获取某分文档 eq:==  
//	         Document myDoc = collection.find(eq("i", 1)).first();  
//	         System.out.println(myDoc.toJson());  
...
//	         System.out.println(myDoc.toJson());  
	        ...
	        // //修改第一个符合条件的数据  
	        // $set 为修改  
//	         collection.updateOne(eq("i", 5), new Document("$set", new  
//	         Document("i", 50)));  
//	         // 获取全部文档,可以看到以前5的地方变成了50  
//	         for (Document cur : collection.find()) {  
//	        	 System.out.println(cur.toJson());  
//	         }  
...
//	         }  
	        ...
	        /************************** 删除数据 *****************************/  
//	        // 删除第一个符合条件的数据  
//	         collection.deleteOne(eq("i", 104));  
//	         // 获取全部文档,可以看到没有104这个数了  
//	         for (Document cur : collection.find()) {  
//	         System.out.println(cur.toJson());  
//	         }  
