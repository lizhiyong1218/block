...
(function (window, $, undefined) {
    ...
    coreUtil.tryExec = function (code, error, final1) {
        var defaults = {
            code: null, error: null, final1: null, tryError: false, tryFinal: false
        };
        var opts = $.extend(defaults, typeof code == "object" ? code : { code: code, error: error, final1: final1 }), ret;
        ...
        if (typeof opts.final1 == "string") { opts.final1 = coreString.toFunction(opts.final1); }
        try {
            ...
            if (coreUtil.isFunction(opts.final1)) {
                var b = opts.tryFinal ? coreUtil.tryExec(opts.final1) : opts.final1();
